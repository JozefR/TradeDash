...
namespace TradeDash.BackEnd.Migrations
{
    ...
    [Migration("20181120200817_AddNullableNavigationPropertyToMoneyManagement")]
    partial class AddNullableNavigationPropertyToMoneyManagement
    {
            ...
            modelBuilder.Entity("TradeDash.BackEnd.Models.MoneyManagement", b =>
                {
                    b.HasOne("TradeDash.BackEnd.Models.Strategy", "Strategy")
                        ...
                        .HasForeignKey("TradeDash.BackEnd.Models.MoneyManagement", "StrategyId");
                });
